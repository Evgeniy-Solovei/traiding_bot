...
class RiskManager:
    ...
    def __init__(
        ...
        Args:
            ...
            max_position_usd: Максимальный размер позиции в USD (если задан)
        """
        ...
        self.max_position_usd = float(max_position_usd) if max_position_usd is not None else None
    ...
    def validate_position(self, position_size: PositionSize) -> Tuple[bool, str]:
        ...
        if position_size.position_size_usd < 1:  # минимум $1
            return False, f"Размер позиции слишком мал: ${position_size.position_size_usd:.2f} (<$1)"
